...
grep -q "| gallery-backed | 8 |" "$TMP_MD"
grep -q "| preview available | 3 |" "$TMP_MD"
grep -q '| `line_trend` | Trend | gallery-backed | \[preview\](gallery/line_trend.png) | yes | yes | yes | yes | yes | yes |' "$TMP_MD"
grep -q '| `density_scatter` | Relationship | preview available | \[preview\](gallery/density_scatter.png) | yes | yes | yes | yes | yes | no |' "$TMP_MD"
