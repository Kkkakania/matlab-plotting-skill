...
grep -q -- "./scripts/render_with_matlab.sh --doctor --out" "$DOC"
...
grep -q -- "--doctor" "$ROOT_DIR/skills/matlab-plotting-skill/SKILL.md"
grep -q "doctor.sh" "$ROOT_DIR/docs/first-five-minutes.md"
grep -q -- "--doctor" "$ROOT_DIR/docs/first-five-minutes.md"
