...
grep -q "bash -n skills/matlab-plotting-skill/scripts/doctor.sh" "$WORKFLOW"
...
grep -q "tests/test_troubleshooting_docs.sh" "$WORKFLOW"
...
grep -q "bash -n tests/test_troubleshooting_docs.sh" "$WORKFLOW"
grep -q "tests/test_docs_500_task_board.sh" "$WORKFLOW"
grep -q "tests/test_render_with_matlab_args.sh" "$WORKFLOW"
grep -q "bash -n tests/test_render_with_matlab_args.sh" "$WORKFLOW"
grep -q "bash -n tests/test_mfigci_dogfood_config.sh" "$WORKFLOW"
...
grep -q "tests/test_stacked_time_series_catalog.sh" "$WORKFLOW"
...
grep -q "tests/test_stacked_time_series_data_contract.sh" "$WORKFLOW"
...
grep -q "tests/test_stacked_time_series_gallery.sh" "$WORKFLOW"
...
grep -q "tests/test_stacked_time_series_safety.sh" "$WORKFLOW"
...
grep -q "tests/test_mfigci_dogfood_config.sh" "$WORKFLOW"
