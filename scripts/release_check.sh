...
echo "== Syntax checks =="
python3 -m py_compile scripts/build_gallery_index.py scripts/build_automation_manifest.py scripts/build_task_manifest.py scripts/check_diagram_examples.py scripts/validate_plot_review.py
