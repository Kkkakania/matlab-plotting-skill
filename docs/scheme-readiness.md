...
`line_trend`, `multi_line_comparison`, `confidence_band`, `zoomed_inset_line`, `positive_negative_area`, `segmented_line`, `scatter_relationship`, `grouped_scatter`, `density_scatter`, `contour_scatter`, `regression_scatter`, `bubble_scatter`, `stacked_time_series`
...
| `regression_scatter` | Relationship | gallery-backed | [preview](gallery/regression_scatter.png) | yes | yes | yes | yes | yes | yes |
| `bubble_scatter` | Relationship | gallery-backed | [preview](gallery/bubble_scatter.png) | yes | yes | yes | yes | yes | yes |
