...
| `stacked_time_series.png` | `stacked_time_series` | synthetic demo data | `mpDemoDataForScheme` -> `mpRenderScheme` -> PNG export | no private data, no external image source |
| `scatter_relationship.png` | `scatter_relationship` | synthetic demo data | `mpDemoDataForScheme` -> temporary CSV -> `mpRun` -> PNG export | no private data, no external image source |
...
| `bubble_scatter.png` | `bubble_scatter` | synthetic demo data | `mpDemoDataForScheme` -> `mpRenderScheme` -> PNG export | no private data, no external image source |
