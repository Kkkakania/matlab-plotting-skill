...
- Added MATLAB regression coverage proving `scatter_relationship.png` is
...
- Added MATLAB regression coverage proving `segmented_line.svg` and
  `segmented_line.pdf` are generated and non-empty.
